...
one common tilt gain for u, v and w and one common hard log-tilt limit.  It does
not add a length-error deadband, a length-error cap, component-specific gains,
