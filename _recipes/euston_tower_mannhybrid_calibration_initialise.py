# -*- coding: utf-8 -*-
"""Initialise the Euston Tower empty-domain MannHybrid calibration.
...
full-scale Euston Tower ABL cases. This replacement obtains the two durations
from explicit user inputs and writes the timing contract consumed by the
Euston Tower calibration driver and spectral-tilt core.
...
def main(argv=None):
    ...
    print("Workflow                : Euston Tower MannHybrid empty-domain calibration")
