...
# -*- coding: utf-8 -*-
"""
Classic native windlespy/Wong downstream calibration for the MannHybridTurb utility.

The active MannHybrid profile is required to have 9 columns:
    z U Iu Iv Iw Lu Lv Lw uwStress

The calibration array is:
    U R11 R22 R33 Lu Lv Lw uwStress

All eight Wong-array quantities, including uwStress, are passed to the native
windlespy update function LES._profileCalibration.new_dfsr_profile_array(...,
relaxation_factor=0.9).  The updated active profile is written back with 9 columns.
"""
...
MODE = "MANNHYBRID"
CALIBRATES_UW = True
ACTIVE_PROFILE_HAS_UW = True
SCRIPT_LABEL = "MannHybrid classic Wong downstream calibration"
